        ...
        <nav className="navbar navbar-expand-md bg-dark py-3" data-bs-theme="dark">
            <div className="container"><a className="navbar-brand d-flex align-items-center" href="#"><span
                ...
                className="bi bi-bezier">
                    ...
                    </svg></span><span>Trip app</span></a>
                <button data-bs-toggle="collapse" className="navbar-toggler" data-bs-target="#navcol-5"><span
                ...
                <div className="collapse navbar-collapse" id="navcol-5">
                    ...
                    <a className="btn btn-primary ms-md-2" role="button" href="#" onClick={logout}>Logout</a>
                </div>
            </div>
        </nav>
    )
