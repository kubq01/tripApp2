...
function UserProfile() {
    ...
    return (
        <Box>
            <Card variant="outlined" style={{ backgroundColor: 'rgba(44, 51, 51, 0.8)', borderRadius: '10px', maxWidth: '400px', margin: 'auto', marginTop: '50px' }}>
                <CardContent className="px-5 py-5 d-flex flex-column align-items-center">
                    <Typography className="px-2" sx={{ fontSize: 30, fontWeight: 'bold', color: 'white' }} gutterBottom>
                        First Name: {user.firstName}
                    </Typography>
                    <Typography sx={{ fontSize: 30, fontWeight: 'bold', color: 'white' }} gutterBottom>
